...
describe('GARS Tests', function () {
    ...
    */
    ...
    function testCoordinateFromPoint(point: Point, value: string): void {
        ...
        expect(
            gars.coordinate(GridType.TWENTY_DEGREE)).to.equal(value.substring(0, 5));
        expect(
            gars.coordinate(GridType.TEN_DEGREE)).to.equal(value.substring(0, 5));
        expect(
            gars.coordinate(GridType.FIVE_DEGREE)).to.equal(value.substring(0, 5));
        expect(
            gars.coordinate(GridType.ONE_DEGREE)).to.equal(value.substring(0, 5));
        expect(
            gars.coordinate(GridType.THIRTY_MINUTE)).to.equal(value.substring(0, 5));
        expect(
            gars.coordinate(GridType.FIFTEEN_MINUTE)).to.equal(value.substring(0, 6));
