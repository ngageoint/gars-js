...
export abstract class GridLabeler extends Labeler {
    ...
    public static readonly DEFAULT_TEXT_SIZE = GARSProperties.getInstance()
        .getDoubleProperty(true, PropertyConstants.LABELER,
    ...
    constructor(enabled: boolean, minZoom = 0, maxZoom?: number, color = Color.black(), textSize = GridLabeler.DEFAULT_TEXT_SIZE, buffer = GridLabeler.DEFAULT_BUFFER) {
